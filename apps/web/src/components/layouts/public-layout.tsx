      ...
      <header className="sticky top-0 z-50 w-full bg-white/30 backdrop-blur-xl border-b border-white/20">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <Link href="/courses" className="text-sm font-medium text-[#00033D]/80 hover:text-[#0033FF] transition-colors">Kelas</Link>
            <Link href="/verify" className="text-sm font-medium text-[#00033D]/80 hover:text-[#0033FF] transition-colors">Verifikasi</Link>
          </nav>
